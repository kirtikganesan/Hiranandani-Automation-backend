...
interface ServiceDueDateEditProps {
  onClose: () => void;
  editId: number;
  initialData: {
...
const ServiceDueDateEdit: React.FC<ServiceDueDateEditProps> = ({ onClose, editId, initialData }) => {
  console.log('[DEBUG] ServiceDueDateEdit initialData:', initialData);
  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-md">
      <h2 className="text-2xl font-bold text-navy-900 mb-6">Service Due Date Edit</h2>
...
export default ServiceDueDateEdit;